...
import { ArrowRight, Code, Zap, Palette, CheckCircle2, ExternalLink, Github, Mail, MapPin, Send } from 'lucide-react';
      ...
      >
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-2xl md:text-3xl text-primary mb-4 font-semibold animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Front-End Engineer
            </p>
            <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.3s' }}>
              I craft <span className="text-primary font-semibold">fast</span>, <span className="text-primary font-semibold">responsive</span>, and <span className="text-primary font-semibold">visually engaging</span> web experiences using React, JavaScript, and modern front-end technologies.
            </p>
            ...
            {/* Floating stats */}
            <div className="grid grid-cols-3 gap-4 mt-16 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.5s' }}>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="text-center p-8 hover:shadow-[0_0_30px_hsl(217_91%_60%/0.3)] transition-all duration-300 animate-fade-in" style={{ animationDelay: '0.1s' }}>
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 mb-4">
            ...
            <Card className="text-center p-8 hover:shadow-[0_0_30px_hsl(217_91%_60%/0.3)] transition-all duration-300 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 mb-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-20">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={value} className="flex items-start gap-2 p-4 rounded-lg bg-card border border-border">
                  ...
                  {category.skills.map((skill) => (
                    ...
                    >
                      <div className="flex flex-col gap-2">
                        ...
                        <Badge className={`${getLevelColor(skill.level)} w-fit text-xs`}>
                          {skill.level}
                        </Badge>
                      </div>
                    </Card>
